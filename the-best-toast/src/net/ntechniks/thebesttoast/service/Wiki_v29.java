 ...
 *  @version 0.28
 */
public class Wiki_v29 implements Serializable
{
    // Master TODO list:
     ...
     *  @since 0.14
     */
    public Wiki_v29(String domain, String scriptPath)
    {
        this.domain = domain;
    ...
    {
        if (!(obj instanceof Wiki_v29))
            return false;
        return domain.equals(((Wiki_v29)obj).domain);
    }
    ...
    public byte[] getImage_v27(String title, int width, int height) throws IOException
    {
    	    
    	title = title.replaceFirst("^(File|Image|" + namespaceIdentifier(6) + "):", "");
    ...
    public class User implements Cloneable
    {
        ...
        {
            return Wiki_v29.this.contribs(username, ns);
        }
    ...
    public class LogEntry implements Comparable<LogEntry>
    {
         ...
         */
        @Override
        public int compareTo(Wiki_v29.LogEntry other)
        {
    ...
    public class Revision implements Comparable<Revision>
    {
        ...
        public int hashCode()
        {
            return (int)revid * 2 - Wiki_v29.this.hashCode();
        }
         ...
         */
        @Override
        public int compareTo(Wiki_v29.Revision other)
        {
            if (timestamp.equals(other.timestamp))
                return 0; // might not happen, but
            return timestamp.after(other.timestamp) ? 1 : -1;
        ...
        {
        	Wiki_v29.this.rollback(this, false, "");
        }
        ...
        {
        	Wiki_v29.this.rollback(this, bot, reason);
        }
    }
